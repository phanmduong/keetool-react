...
export default (
    <Route>
        <Route path="/" component={AppContainer}>
            ...
            <Route
                path="/client-config/:clientId/create"
                component={CreateClientConfigContainer}
                type="create"
            />
            <Route
                path="/client-config/:clientId/:clientConfigId/edit"
                component={CreateClientConfigContainer}
                type="edit"
            />
            ...
            {/*End blog routes*/}
            <Route path="/issue/list" component={IssuesContainer} />
        </Route>
