...
export const LOGO_SIDEBAR =
    PROTOCOL + "d255zuevr6tr8p.cloudfront.net/logo/Artboard+5+copy.png";
export const LOGO_MAIN =
    PROTOCOL + "d255zuevr6tr8p.cloudfront.net/logo/Artboard+5.png";
export const LOGO_LOGIN =
    PROTOCOL + "d255zuevr6tr8p.cloudfront.net/logo/logo_long.png";
...
export const NO_AVATAR =
    PROTOCOL + "d255zuevr6tr8p.cloudfront.net/no-avatar.png";
